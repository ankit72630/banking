          ...
          {applicationDetails.isStp && (
            <div className="body__notes">
              <div className="body__notes__desc">
                {thankyou[applicationDetails.thankyouProp].feedbackInfo_1}
                <a
                  target="_blank"
                  rel="feedback noreferrer"
                  href={applicationDetails.feedbackUrl}
                >
                  {thankyou[applicationDetails.thankyouProp].feedbackInfo_2}
                </a>{" "}
                {thankyou[applicationDetails.thankyouProp].feedbackInfo_3}
              </div>
            </div>
          )}
        </div>
