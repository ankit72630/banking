    ...
    return (dispatch: AppDispatch) => {
        ...
        if (radioResidency) {
            if (radioResidency.logical_field_name === 'residency_status') {
                ...
                const earner = ["name_of_employer", "nature_of_employer", "job_title"];
                const selfEmployed = ["name_of_business", "nature_of_employer", "job_title"];
                const userSelection = {
                ...
                if (radioResidency.value === '0') {
                    showFields = [];
                    removeFields = ['preferred_credit_limit'];
                } else if (radioResidency.value === '1') {
                    showFields = ['preferred_credit_limit'];
                    removeFields = [];
                }
                ...
                if (radioResidency.value === 'Y') {
                    ...
                    removeFields = ['work_type','name_of_employer','name_of_employer_other','name_of_business','job_title','nature_of_employer','myinfo_data_cli'];
                }
                ssfStages = showFields;
                dispatch(fieldErrorAction.removeMandatoryFields(removeFields));
                dispatch(
